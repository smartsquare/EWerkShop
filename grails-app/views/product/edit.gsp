...
<div class="nav" role="navigation">
    <ul>
        ...
        <g:if test="${productFactsheet}">
            <li><g:link controller="productFactsheet" action="edit" params="[id: productFactsheet.id]"><g:message
                    code="product.editExistingFactsheet.label"/></g:link></li>
        </g:if>
        <g:else>
            <li><g:link controller="productFactsheet" action="create"
                        params="[productId: productInstance.id]"><g:message
                        code="product.addFactsheet.label"/></g:link></li>
        </g:else>
    </ul>
</div>
