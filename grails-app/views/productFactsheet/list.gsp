...
<body>
<a href="#list-productFactsheet" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="productId"
                              title="${message(code: 'productFactsheet.productId.label', default: 'Product Id')}"/>

            <g:sortableColumn property="operatingVoltage"
                              title="${message(code: 'productFactsheet.operatingVoltage.label', default: 'Operating Voltage')}"/>

            <g:sortableColumn property="powerInput"
                              title="${message(code: 'productFactsheet.powerInput.label', default: 'Power Input')}"/>
        ...
        <g:each in="${productFactsheetInstanceList}" status="i" var="productFactsheetInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${productFactsheetInstance.id}">${fieldValue(bean: productFactsheetInstance, field: "productId")}</g:link></td>
