...
<div class="fieldcontain ${hasErrors(bean: productFactsheetInstance, field: 'productId', 'error')} required">
    ...
    <g:field readonly="Y" type="number" name="productId" required=""
             value="${fieldValue(bean: productFactsheetInstance, field: 'productId')}"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: productFactsheetInstance, field: 'operatingVoltage', 'error')} required">
    ...
    <g:field type="long" name="operatingVoltage" required=""
             value="${fieldValue(bean: productFactsheetInstance, field: 'operatingVoltage')}"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: productFactsheetInstance, field: 'powerInput', 'error')} required">
    ...
    <g:field type="long" name="powerInput" required=""
             value="${fieldValue(bean: productFactsheetInstance, field: 'powerInput')}"/>
</div>
...
<div class="fieldcontain">
    ...
    <g:field type="long" name="dynBladeLength"
             value="${productFactsheetInstance?.isAttached() ? productFactsheetInstance?.getAt('dynBladeLength') : null}"/>
</div>
...
<div class="fieldcontain">
    ...
    <g:field type="long" name="dynBladeDiameter"
             value="${productFactsheetInstance?.isAttached() ? productFactsheetInstance?.getAt('dynBladeDiameter') : null}"/>
</div>
