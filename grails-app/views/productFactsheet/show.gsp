...
<html>
	...
	<body>
		<a href="#show-productFactsheet" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="show-productFactsheet" class="content scaffold-show" role="main">
			...
			<ol class="property-list productFactsheet">
				...
				<li class="fieldcontain">
					<span id="productId-label" class="property-label"><g:message code="productFactsheet.productId.label" default="Product Id" /></span>
					
						<span class="property-value" aria-labelledby="productId-label"><g:fieldValue bean="${productFactsheetInstance}" field="productId"/></span>
				...
				<li class="fieldcontain">
					<span id="operatingVoltage-label" class="property-label"><g:message code="productFactsheet.operatingVoltage.label" default="Operating Voltage" /></span>
					
						<span class="property-value" aria-labelledby="operatingVoltage-label"><g:fieldValue bean="${productFactsheetInstance}" field="operatingVoltage"/></span>
				...
				<li class="fieldcontain">
					<span id="powerInput-label" class="property-label"><g:message code="productFactsheet.powerInput.label" default="Power Input" /></span>
					
						<span class="property-value" aria-labelledby="powerInput-label"><g:fieldValue bean="${productFactsheetInstance}" field="powerInput"/></span>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${productFactsheetInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
